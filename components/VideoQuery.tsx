  ...
  React.useEffect(() => {
    ...
    const generate = async () => {
      try {
        ...
        // Draw the first available frame (avoid programmatic seeking which
        // can cause extra blob range requests and "file not found" errors)
  ...
  const submit = async (e?: React.FormEvent) => {
    ...
    try {
      ...
      try {
        ...
        // Only include thumbnail_url if we actually have one locally; avoid
        // overwriting a thumbnail generated by Cloud Run with null.
        if (thumbnailDataUrl) updatePayload.thumbnail_url = thumbnailDataUrl
